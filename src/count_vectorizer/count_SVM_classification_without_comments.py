...
source_codes_tokenized = np.load("../../data/tokenized_data/source_codes_without_comms_count_tokenized.npy", allow_pickle=True)
...
with open("../../data/fitted_classificators/svm_count_vect_without_comms.pkl", 'wb') as f:
    pickle.dump(svm, f)
