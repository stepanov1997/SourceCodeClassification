...
binary_vectorizer = CountVectorizer(lowercase=False, tokenizer=tokenize)
...
with open("../../data/fitted_vectorizers/count_vect_without_comms.pkl", 'wb') as f:
    pickle.dump(binary_vectorizer, f)
np.save("../../data/tokenized_data/source_codes_without_comms_count_tokenized.npy", source_codes_binary_tokenized)
