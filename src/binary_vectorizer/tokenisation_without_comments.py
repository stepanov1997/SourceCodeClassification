...
with open("../../data/fitted_vectorizers/binary_vect_without_comms.pkl", 'wb') as f:
    pickle.dump(binary_vectorizer, f)
np.save("../../data/tokenized_data/source_codes_without_comms_binary_tokenized.npy", source_codes_binary_tokenized)
