...
source_codes_tokenized = np.load("../../data/tokenized_data/source_codes_tfidf_tokenized.npy", allow_pickle=True)
...
with open("../../data/fitted_classificators/knn_tfidf_vect.pkl", 'wb') as f:
    pickle.dump(knn, f)
